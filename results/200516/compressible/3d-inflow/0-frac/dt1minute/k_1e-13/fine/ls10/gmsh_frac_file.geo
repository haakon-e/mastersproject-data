Geometry.Tolerance = 3.333333333333333e-10;
// Define points
p0 = newp; Point(p0) = {-10.0, 0.0, 20.0, 3.0 };
p1 = newp; Point(p1) = {-10.0, 0.0, -10.0, 3.0 };
p2 = newp; Point(p2) = {-10.0, 30.0, -10.0, 3.0 };
p3 = newp; Point(p3) = {-10.0, 30.0, 20.0, 3.0 };
p4 = newp; Point(p4) = {20.0, 0.0, 20.0, 3.0 };
p5 = newp; Point(p5) = {20.0, 0.0, -10.0, 3.0 };
p6 = newp; Point(p6) = {20.0, 30.0, -10.0, 3.0 };
p7 = newp; Point(p7) = {20.0, 30.0, 20.0, 3.0 };
